...
# 5 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 208 "/scrap/drbd/drbd/drbd_nl.c"
	struct sk_buff *skb, struct genl_info *info, unsigned flags)
{
# 211 "/scrap/drbd/drbd/drbd_nl.c"
# 8 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 214 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	struct drbd_genlmsghdr *d_in = info->userhdr;
# 9 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 211 "/scrap/drbd/drbd/drbd_nl.c"
...
# 17 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2212 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	unsigned int flags = ((struct drbd_genlmsghdr *) info->userhdr)->flags;
# 18 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2202 "/scrap/drbd/drbd/drbd_nl.c"
...
# 26 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2517 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	kvfree_rcu(old_disk_conf);
# 27 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2502 "/scrap/drbd/drbd/drbd_nl.c"
...
# 35 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2747 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
		struct block_device *bdev, bool do_bd_unlink)
# 36 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2727 "/scrap/drbd/drbd/drbd_nl.c"
{
# 2729 "/scrap/drbd/drbd/drbd_nl.c"
# 38 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2752 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	if (!bdev)
# 39 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2729 "/scrap/drbd/drbd/drbd_nl.c"
		return;
	if (do_bd_unlink)
# 2733 "/scrap/drbd/drbd/drbd_nl.c"
# 43 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2758 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
		bd_unlink_disk_holder(bdev, device->vdisk);
	blkdev_put(bdev, FMODE_READ | FMODE_WRITE | FMODE_EXCL);
# 45 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2733 "/scrap/drbd/drbd/drbd_nl.c"
}
...
# 53 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2779 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
			  ldev->md_bdev,
# 54 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2744 "/scrap/drbd/drbd/drbd_nl.c"
			  ldev->md_bdev != ldev->backing_bdev);
# 2746 "/scrap/drbd/drbd/drbd_nl.c"
# 56 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2784 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	close_backing_dev(device, ldev->backing_bdev, true);
# 57 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2746 "/scrap/drbd/drbd/drbd_nl.c"
...
# 63 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2793 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
static struct block_device *open_backing_dev(struct drbd_device *device,
# 64 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2752 "/scrap/drbd/drbd/drbd_nl.c"
		const char *bdev_path, void *claim_ptr)
{
# 2758 "/scrap/drbd/drbd/drbd_nl.c"
# 70 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2799 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	struct block_device * bdev = blkdev_get_by_path(bdev_path,
				  FMODE_READ | FMODE_WRITE | FMODE_EXCL,
				  claim_ptr);
	if (IS_ERR(bdev)) {
# 74 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2758 "/scrap/drbd/drbd/drbd_nl.c"
		drbd_err(device, "open(\"%s\") failed with %ld\n",
# 2760 "/scrap/drbd/drbd/drbd_nl.c"
# 76 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2807 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
				bdev_path, PTR_ERR(bdev));
# 77 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2760 "/scrap/drbd/drbd/drbd_nl.c"
	}
# 2762 "/scrap/drbd/drbd/drbd_nl.c"
# 79 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2812 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	return bdev;
# 80 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2762 "/scrap/drbd/drbd/drbd_nl.c"
}

static int link_backing_dev(struct drbd_device *device,
# 2766 "/scrap/drbd/drbd/drbd_nl.c"
# 84 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2819 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
		const char *bdev_path, struct block_device *bdev)
# 85 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2766 "/scrap/drbd/drbd/drbd_nl.c"
{
# 2768 "/scrap/drbd/drbd/drbd_nl.c"
# 87 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2824 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	int err = bd_link_disk_holder(bdev, device->vdisk);
# 88 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2768 "/scrap/drbd/drbd/drbd_nl.c"
	if (err) {
# 90 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
...
# 98 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2857 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	struct block_device *bdev;
# 99 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2781 "/scrap/drbd/drbd/drbd_nl.c"
	void *meta_claim_ptr;
	int err;

# 2786 "/scrap/drbd/drbd/drbd_nl.c"
# 104 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2864 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	bdev = open_backing_dev(device, new_disk_conf->backing_dev, device);
	if (IS_ERR(bdev))
# 106 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2786 "/scrap/drbd/drbd/drbd_nl.c"
		return ERR_OPEN_DISK;

# 2789 "/scrap/drbd/drbd/drbd_nl.c"
# 109 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2871 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	err = link_backing_dev(device, new_disk_conf->backing_dev, bdev);
# 110 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2789 "/scrap/drbd/drbd/drbd_nl.c"
	if (err) {
		/* close without unlinking; otherwise error path will try to unlink */
# 2792 "/scrap/drbd/drbd/drbd_nl.c"
# 113 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2877 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
		close_backing_dev(device, bdev, false);
# 114 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2792 "/scrap/drbd/drbd/drbd_nl.c"
		return ERR_OPEN_DISK;
	}
# 2796 "/scrap/drbd/drbd/drbd_nl.c"
# 118 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2883 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	nbc->backing_bdev = bdev;
# 119 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2796 "/scrap/drbd/drbd/drbd_nl.c"
...
# 128 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2911 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	bdev = open_backing_dev(device, new_disk_conf->meta_dev, meta_claim_ptr);
	if (IS_ERR(bdev))
# 130 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2812 "/scrap/drbd/drbd/drbd_nl.c"
...
# 136 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2920 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	if (bdev != nbc->backing_bdev) {
		err = link_backing_dev(device, new_disk_conf->meta_dev,
				       bdev);
# 139 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2818 "/scrap/drbd/drbd/drbd_nl.c"
		if (err) {
			/* close without unlinking; otherwise error path will try to unlink */
# 2821 "/scrap/drbd/drbd/drbd_nl.c"
# 142 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2928 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
			close_backing_dev(device, bdev, false);
# 143 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2821 "/scrap/drbd/drbd/drbd_nl.c"
			return ERR_OPEN_MD_DISK;
		}
	}
...
# 149 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2936 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	nbc->md_bdev = bdev;
# 150 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 2827 "/scrap/drbd/drbd/drbd_nl.c"
	return NO_ERROR;
}
...
# 158 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 4128 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	kvfree_rcu(old_net_conf);
# 159 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 4008 "/scrap/drbd/drbd/drbd_nl.c"
...
# 167 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 4269 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	kvfree_rcu(old_peer_device_conf);
# 168 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 4144 "/scrap/drbd/drbd/drbd_nl.c"
	kfree(old_plan);
...
# 176 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 5358 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
		kvfree_rcu(old_disk_conf);
# 177 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 5228 "/scrap/drbd/drbd/drbd_nl.c"
		new_disk_conf = NULL;
	}
...
# 185 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 7007 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	struct drbd_genlmsghdr *dh = info->userhdr;
# 186 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 6872 "/scrap/drbd/drbd/drbd_nl.c"
...
# 195 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 7183 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	del_timer_sync(&resource->twopc_timer);
	del_timer_sync(&resource->peer_ack_timer);
# 197 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 7044 "/scrap/drbd/drbd/drbd_nl.c"
...
# 205 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 7947 "/scrap/drbd/drbd/build-6.1.111-mdl+/drbd_nl.c"
	kvfree_rcu(old_res_name);
# 206 "/scrap/drbd/drbd/build-6.1.111-mdl+/.patches/drbd_nl.c.patch"
# 7802 "/scrap/drbd/drbd/drbd_nl.c"
