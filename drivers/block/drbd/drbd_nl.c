...
# 5 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 30 "/scrap/drbd/drbd/drbd_nl.c"
#include "drbd_transport.h"
#include "drbd_dax_pmem.h"
# 33 "/scrap/drbd/drbd/drbd_nl.c"
# 8 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 38 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
#include <asm/unaligned.h>
# 9 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 33 "/scrap/drbd/drbd/drbd_nl.c"
...
# 17 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 221 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	struct drbd_genlmsghdr *d_in = info->userhdr;
# 18 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 211 "/scrap/drbd/drbd/drbd_nl.c"
...
# 26 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2124 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	lim = q->limits;
# 27 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2109 "/scrap/drbd/drbd/drbd_nl.c"
...
# 36 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2173 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	q->limits = lim;
	blk_queue_max_hw_sectors(q, lim.max_hw_sectors);
	blk_queue_max_discard_sectors(q, lim.max_hw_discard_sectors);
	if (bdev)
		disk_update_readahead(device->vdisk);
# 41 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2154 "/scrap/drbd/drbd/drbd_nl.c"
}
...
# 49 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2224 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	unsigned int flags = ((struct drbd_genlmsghdr *) info->userhdr)->flags;
# 50 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2196 "/scrap/drbd/drbd/drbd_nl.c"
...
# 58 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2531 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	kvfree_rcu(old_disk_conf);
# 59 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2498 "/scrap/drbd/drbd/drbd_nl.c"
...
# 67 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2761 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
		struct block_device *bdev, bool do_bd_unlink)
# 68 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2723 "/scrap/drbd/drbd/drbd_nl.c"
{
# 2725 "/scrap/drbd/drbd/drbd_nl.c"
# 70 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2768 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	if (!bdev)
# 71 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2725 "/scrap/drbd/drbd/drbd_nl.c"
		return;
	if (do_bd_unlink)
# 2729 "/scrap/drbd/drbd/drbd_nl.c"
# 75 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2776 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
		bd_unlink_disk_holder(bdev, device->vdisk);
	blkdev_put(bdev, FMODE_READ | FMODE_WRITE | FMODE_EXCL);
# 77 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2729 "/scrap/drbd/drbd/drbd_nl.c"
}
...
# 85 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2793 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
			  ldev->md_bdev,
# 86 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2740 "/scrap/drbd/drbd/drbd_nl.c"
			  ldev->md_bdev != ldev->backing_bdev);
# 2742 "/scrap/drbd/drbd/drbd_nl.c"
# 88 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2800 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	close_backing_dev(device, ldev->backing_bdev, true);
# 89 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2742 "/scrap/drbd/drbd/drbd_nl.c"
...
# 95 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2811 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
static struct block_device *open_backing_dev(struct drbd_device *device,
# 96 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2748 "/scrap/drbd/drbd/drbd_nl.c"
		const char *bdev_path, void *claim_ptr)
{
# 2754 "/scrap/drbd/drbd/drbd_nl.c"
# 102 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2819 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	struct block_device *bdev = blkdev_get_by_path(bdev_path,
				  FMODE_READ | FMODE_WRITE | FMODE_EXCL,
				  claim_ptr);
	if (IS_ERR(bdev)) {
# 106 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2754 "/scrap/drbd/drbd/drbd_nl.c"
		drbd_err(device, "open(\"%s\") failed with %ld\n",
# 2756 "/scrap/drbd/drbd/drbd_nl.c"
# 108 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2829 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
				bdev_path, PTR_ERR(bdev));
# 109 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2756 "/scrap/drbd/drbd/drbd_nl.c"
	}
# 2758 "/scrap/drbd/drbd/drbd_nl.c"
# 111 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2836 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	return bdev;
# 112 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2758 "/scrap/drbd/drbd/drbd_nl.c"
}

static int link_backing_dev(struct drbd_device *device,
# 2762 "/scrap/drbd/drbd/drbd_nl.c"
# 116 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2845 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
		const char *bdev_path, struct block_device *bdev)
# 117 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2762 "/scrap/drbd/drbd/drbd_nl.c"
{
# 2764 "/scrap/drbd/drbd/drbd_nl.c"
# 119 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2852 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	int err = bd_link_disk_holder(bdev, device->vdisk);
# 120 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2764 "/scrap/drbd/drbd/drbd_nl.c"
	if (err) {
# 122 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
...
# 130 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2871 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	struct block_device *bdev;
# 131 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2777 "/scrap/drbd/drbd/drbd_nl.c"
	void *meta_claim_ptr;
	int err;

# 2782 "/scrap/drbd/drbd/drbd_nl.c"
# 136 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2880 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	bdev = open_backing_dev(device, new_disk_conf->backing_dev, device);
	if (IS_ERR(bdev))
# 138 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2782 "/scrap/drbd/drbd/drbd_nl.c"
		return ERR_OPEN_DISK;

# 2785 "/scrap/drbd/drbd/drbd_nl.c"
# 141 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2889 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	err = link_backing_dev(device, new_disk_conf->backing_dev, bdev);
# 142 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2785 "/scrap/drbd/drbd/drbd_nl.c"
	if (err) {
		/* close without unlinking; otherwise error path will try to unlink */
# 2788 "/scrap/drbd/drbd/drbd_nl.c"
# 145 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2897 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
		close_backing_dev(device, bdev, false);
# 146 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2788 "/scrap/drbd/drbd/drbd_nl.c"
		return ERR_OPEN_DISK;
	}
# 2792 "/scrap/drbd/drbd/drbd_nl.c"
# 150 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2905 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	nbc->backing_bdev = bdev;
# 151 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2792 "/scrap/drbd/drbd/drbd_nl.c"
...
# 160 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2925 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	bdev = open_backing_dev(device, new_disk_conf->meta_dev, meta_claim_ptr);
	if (IS_ERR(bdev))
# 162 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2808 "/scrap/drbd/drbd/drbd_nl.c"
...
# 168 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2936 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	if (bdev != nbc->backing_bdev) {
		err = link_backing_dev(device, new_disk_conf->meta_dev,
				       bdev);
# 171 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2814 "/scrap/drbd/drbd/drbd_nl.c"
		if (err) {
			/* close without unlinking; otherwise error path will try to unlink */
# 2817 "/scrap/drbd/drbd/drbd_nl.c"
# 174 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2946 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
			close_backing_dev(device, bdev, false);
# 175 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2817 "/scrap/drbd/drbd/drbd_nl.c"
			return ERR_OPEN_MD_DISK;
		}
	}
...
# 181 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2956 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	nbc->md_bdev = bdev;
# 182 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 2823 "/scrap/drbd/drbd/drbd_nl.c"
	return NO_ERROR;
}
...
# 190 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 4143 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	kvfree_rcu(old_net_conf);
# 191 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 4005 "/scrap/drbd/drbd/drbd_nl.c"
...
# 199 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 4284 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	kvfree_rcu(old_peer_device_conf);
# 200 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 4141 "/scrap/drbd/drbd/drbd_nl.c"
	kfree(old_plan);
...
# 208 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 5373 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
		kvfree_rcu(old_disk_conf);
# 209 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 5225 "/scrap/drbd/drbd/drbd_nl.c"
		new_disk_conf = NULL;
	}
...
# 217 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 7023 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	struct drbd_genlmsghdr *dh = info->userhdr;
# 218 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 6870 "/scrap/drbd/drbd/drbd_nl.c"
...
# 227 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 7199 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	del_timer_sync(&resource->twopc_timer);
	del_timer_sync(&resource->peer_ack_timer);
# 229 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 7042 "/scrap/drbd/drbd/drbd_nl.c"
...
# 237 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 7963 "/scrap/drbd/drbd/build-6.1.134-mdl+/drbd_nl.c"
	kvfree_rcu(old_res_name);
# 238 "/scrap/drbd/drbd/build-6.1.134-mdl+/.patches/drbd_nl.c.patch"
# 7800 "/scrap/drbd/drbd/drbd_nl.c"
